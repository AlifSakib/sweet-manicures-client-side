      ...
      <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <div className="mt-6">
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center h-12 px-6 font-semibold tracking-wide text-teal-900 transition duration-200 rounded shadow-md hover:text-deep-purple-900 bg-teal-accent-400 hover:bg-deep-purple-accent-100 focus:shadow-outline focus:outline-none"
            >
              Signup
            </button>
          </div>
        ...
        <div className="flex items-center mt-6 -mx-2">
          ...
          <Link
            href="#"
            className="p-2 mx-2 text-sm font-medium text-sky-500 transition-colors duration-300 transform bg-gray-500 rounded-md hover:bg-gray-200"
          >
